...
package org.wso2.custom.password.policy.validator.internal;

import org.wso2.carbon.identity.governance.IdentityGovernanceService;
import org.wso2.custom.password.policy.validator.handler.CustomPasswordPolicyValidationHandler;
...
public class CustomPasswordPolicyServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            CustomPasswordPolicyServiceDataHolder.getInstance().setBundleContext(bundleContext);

            CustomPasswordPolicyValidationHandler handler = new CustomPasswordPolicyValidationHandler();
            context.getBundleContext().registerService(AbstractEventHandler.class.getName(), handler, null);
            log.info("Custom Password Policy validator is activated.");
    ...
    protected void unsetIdentityGovernanceService(IdentityGovernanceService idpManager) {
        CustomPasswordPolicyServiceDataHolder.getInstance().setIdentityGovernanceService(null);
    }

    protected void setIdentityGovernanceService(IdentityGovernanceService idpManager) {
        CustomPasswordPolicyServiceDataHolder.getInstance().setIdentityGovernanceService(idpManager);
    }
